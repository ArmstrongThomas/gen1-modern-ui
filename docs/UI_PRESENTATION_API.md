...
Version 0.7.8 uses four released hooks plus a narrowly scoped class wrapper and
...
- Do not assume a custom engine build: version 0.7.8 targets released game
